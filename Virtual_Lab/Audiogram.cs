...
namespace Audiogram_Dev
{
	...
	/// </summary>
	public class Audiogram : System.Windows.Forms.Form
	{
		...
		private const int MIN_X = 63;
		private const int MAX_X = 574;
		private const int MIN_Y = 85;
		private const int MAX_Y = 470;
		...
		private void InitializeComponent()
		{
            ...
            this.boundingBox.Size = new System.Drawing.Size(569, 570);
            ...
            this.KeyPress += new System.Windows.Forms.KeyPressEventHandler(this.Audiogram_KeyPress);
		...
		public void Place_Pt(int X, int Y) 
		{
            ...
            vltl.EvalAudiogramUpdate(ConvertXCoord(X), ConvertYCoord(Y), CurrentSymbol);
		}
...
#region removemesoon
        ...
        private void Audiogram_KeyPress(object sender, KeyPressEventArgs e)
        {
