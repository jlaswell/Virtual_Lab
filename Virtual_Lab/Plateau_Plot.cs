...
namespace Plateau_Plot
{
	/// <summary>
	/// Summary description for Form2.
	/// </summary>
	public class Plateau_Plot : System.Windows.Forms.Form
	{
		...
		{
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Plateau_Plot));
            ...
            this.Name = "Plateau_Plot";
            this.Text = "Plateau Plot";
            this.Load += new System.EventHandler(this.Plateau_Plot_Load);
		...
		public void PlotDataPt(int X, int Y)
		{
			...
			// Draw the points
			this.Paint += new PaintEventHandler(Plateau_Plot_Paint);
		...
		public void ConnectPoints()
		{
			...
			// Draw the lines
			this.Paint += new PaintEventHandler(Plateau_Plot_Line_Paint);
			this.PlotArea.Invalidate();
		}
...
//			temp.X += 4;
        ...
        private void Plateau_Plot_Load(object sender, EventArgs e)
        {
